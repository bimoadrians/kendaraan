                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="col-xl-12 col-lg-12">
                                            Negara Tujuan<a style="color: #e74a3b">*</a>
                                        </div>
                                        <div class="row col-xl-12 col-lg-12 mb-2">
                                            <div class="col-lg-9 pt-1 pb-1">
                                                <select required class="select_negara_tujuan" name="negara_tujuan[]" multiple="multiple" style="width: 100%;"></select>
                                            </div>
                                        </div>
                                        <script>
                                            $(document).ready(function() {
                                                var negaralist = 
                                                [<?php foreach ($neg as $neg) : ?>"<?php echo $neg['negara_tujuan']?>",<?php endforeach?>]

                                                $(".select_negara_tujuan").select2({
                                                    data:negaralist,
                                                    placeholder: "",
                                                    allowClear: true
                                                    // tags: true,
