                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <?php if ($role == 'admin') { ?>
                                            <div class="col-xl-12 col-lg-12">
                                                NIK Personil Perjalanan Dinas
                                            </div>
                                            <div class="row col-xl-12 col-lg-12 mb-3">
                                                <div class="col-lg-9 pt-1 pb-1">
                                                    <select required class="select_nik" name="nik" style="width: 100%;"></select>
                                                </div>
                                            </div>
                                            <script>
                                                $(document).ready(function() {
                                                    var niklist =
                                                    [<?php foreach ($nik as $nik) : ?>"<?php echo $nik['nik']?> - <?php echo $nik['niknm']?> - <?php echo $nik['strorg']?>",<?php endforeach ?>]
                                        ...
                                        <div class="row col-xl-12 col-lg-12">
                                            <div class="col-lg-9 pt-1 pb-1 mb-3">
                                                <div class="form-outline">
                                                    Jumlah Personil
                                                    <input required type="number" id="input_jumlah_personil" class="form-control" name="jumlah_personil" value="<?php echo(isset($jumlah_personil)) ? $jumlah_personil : "" ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row col-xl-12 col-lg-12">
                                            <div class="form-group col-lg-3 pt-1 pb-1">
                                                Tanggal Keberangkatan
                                                <input required type="date" class="form-control" name="tanggal_berangkat" id="input_tanggal_berangkat">
                                            </div>
                                            <div class="form-group col-lg-3 pt-1 pb-1">
                                                Tanggal Pulang
                                                <input required type="date" class="form-control" name="tanggal_pulang" id="input_tanggal_pulang">
                                            </div>
                                        </div>
