                            ...
                            <div class="card-body">
                                <?php foreach ($tiket as $ti => $tik) { ?>
                                    <?php if ($tik['batal_tiket'] == 3) { ?>
                                        ...
                                        <div style="font-size: 24px">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <a class="btn btn-secondary" type="button" href="<?php echo site_url("tiket_admin"); ?>" style="font-size:100%">Batalkan</a>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div style="font-size: 24px">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <input required type="text" autocomplete="off" class="form-control mb-3" name="harga_tiket" id="currency-field" value="<?php echo "Rp"; ?>" data-type="currency">
