                                    ...
                                    <table id="myTable" class="display nowrap cell-border" style="width=100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center" style="color: #5a5c69;">Luar Kota
                                                </td>
                                                <td class="text-center" style="color: #5a5c69;">Bimo Adrian Septianto</td>
                                                <td class="text-center" style="color: #5a5c69;">1 Januari 2024</td>
                                                <td class="text-center" style="color: #5a5c69;">06:00</td>
                                                <td class="text-center" style="color: #5a5c69;">Rumah</td>
                                                <td class="text-center" style="color: #5a5c69;"></td>
                                                <td class="text-center" style="color: #5a5c69;">Ertiga Putih AD 88831 CP</td>
