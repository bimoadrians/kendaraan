                                ...
                                <div class="card-body">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="col-xl-12 col-lg-12 mb-3">
                                            ...
                                            Note Treasury
                                                <input type="text" autocomplete="off" class="form-control mt-3" id="input_treasury" name="treasury" value="<?php echo(isset($treasury)) ? $treasury : $notetreasury['treasury'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 mb-3">
                                            <input type="submit" class="btn btn-success" name="submit" value="Simpan Data" id="submit">
                                            <a href= "<?php echo $datapb ?>" class="btn btn-secondary"> Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
