                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12">
                                            <table class="table table-bordered mb-4">
                                                <thead>
                                                    <tr>
                                                        <th rowspan ="2" class="text-center" style="vertical-align: middle; color: #5a5c69;">ID Transaksi</th>
                                                        <?php if ($role == 'treasury' && $submit == 1 && $valas_kurs != 'IDR') { ?>
                                                            <th rowspan ="2" class="text-center" style="vertical-align: middle; color: #5a5c69;">Kurs</th>
                                                        <?php } else { ?>
                                                    
                                                        <?php } ?>
                                                        <?php if ($role == 'gs' && $submit == 2) { ?>
                                                            <th rowspan ="2" class="text-center" style="vertical-align: middle; color: #5a5c69;">Berangkat dari Kota</th>
                                                        <?php } else { ?>
                                                    
                                                        <?php } ?>
                                                        <th rowspan ="2" class="text-center" style="vertical-align: middle; color: #5a5c69;">No PJUM</th>
                                                        <?php if ($role != 'gs') { ?>
                                                            <th rowspan ="2" class="text-center" style="vertical-align: middle; color: #5a5c69;">Tanggal Pembuatan No PJUM</th>
                                                        <?php } ?>
                                                        <th colspan ="<?php echo $index; ?>" class="text-center" style="color: #5a5c69;">PUM</th>
                                                    </tr>
                                                    <tr>
                                                        <?php foreach ($kode_valas as $ko_val) { ?>
                                                            <?php if(!empty($ko_val['kode_valas'])){ ?>
                                                                <th class="text-center" style="color: #5a5c69"><?php echo $ko_val['kode_valas']?></th>
                                                            <?php } else { ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th class="text-center" scope="row" style="color: #5a5c69;">
                                                            <a href="<?php echo site_url("detailtransaksi/$id_transaksi")?>"><?php echo $id['id_transaksi']; echo("/"); echo("Perjalanan Dinas Luar Negeri"); echo("/"); echo $id['jumlah_personil']; echo("/"); foreach ($neg as $neg) : echo $neg['negara_tujuan']; endforeach ?></a>
                                                        </th>
                                                        <?php if ($role == 'treasury' && $submit == 1 && $valas_kurs != 'IDR') { ?>
                                                            <?php if(empty($kurs)) { ?>
                                                                <th class="text-center" scope="row" style="color: #5a5c69;">
                                                                    <a href="<?php echo site_url("kurspjum/$id_transaksi/$jenis_biaya/$id_pjum") ?>" class="btn btn-success"><abbr title="Klik untuk menambahkan nilai Kurs Tengah BI" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none">Input Kurs Tengah BI</abbr></a>
                                                                </th>
                                                            <?php } else { ?>
                                                                ...
                                                                ?>
                                                                    <th class="text-center" scope="row" style="color: #5a5c69;">
                                                                        <a href="<?php echo site_url("editkurspjum/$id_transaksi/$jenis_biaya/$id_pjum/$id_kurs") ?>"><abbr title="Klik untuk edit nilai Kurs Tengah BI" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo number_format($kur['kurs'], 2, ',', '.'); ?></abbr></a>
                                                                    </th>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                                        ...
                                                        <?php foreach ($nomor as $nomor) { ?>
                                                            ...
                                                            <?php foreach ($valas as $key => $value) { ?>
                                                                <?php if($nomor['id_pjum'] == $value['id_pjum']){ ?>
                                                                    <?php if($role == 'admin' && $nomor['tanggal'] == null && $submit == 0 || $role == 'user' && $nomor['tanggal'] == null && $submit == 0) { ?>
                                                                        <th class="text-center" scope="row" style="color: #5a5c69;">
                                                                            <a href="<?php echo site_url("tanggalpjum/$id_pjum_tanggal/$id_transaksi/$jenis_biaya") ?>" class="btn btn-success"><abbr title="Klik untuk menambahkan tanggal pembuatan no PJUM" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none">Input Tanggal Pembuatan No PJUM</abbr></a>
                                                                        </th>
                                                                    ...
                                                                    <?php } else if($role == 'admin' && $nomor['tanggal'] != null && $submit == 0 || $role == 'user' && $nomor['tanggal'] != null && $submit == 0) { ?>
                                                                        <th class="text-center" scope="row" style="color: #5a5c69;">
                                                                            <a href="<?php echo site_url("tanggalpjum/$id_pjum_tanggal/$id_transaksi/$jenis_biaya") ?>"><abbr title="Klik untuk menambahkan tanggal pembuatan no PJUM" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo tanggal_indo1($nomor['tanggal']); ?></abbr></a>
                                                                        </th>
                                                                    <?php } else if($role == 'gs') { ?>
                                                        ...
                                                        ?>
                                                            <?php if(!($pu['pum'] == null)){ ?>
                                                                <?php if($role == 'admin' && $submit == 0 || $role == 'user' && $submit == 0 ) { ?>
                                                                    <th class="text-center" scope="row" style="color: #5a5c69">
                                                                        <a href="<?php echo site_url("editbiayapum/$id_pum/$id_transaksi/$jenis_biaya/$id_pjum") ?>" style="color: #5a5c69"><abbr title="Klik untuk melakukan edit biaya" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo $pu['simbol']; echo number_format($pu['pum'], 2, ',', '.');?></abbr></a>
                                                                    </th>
                                                                <?php } else { ?>
                                                                    <th class="text-center" scope="row" style="color: #5a5c69">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="myTable" class="table table-bordered mb-4">
                                        <thead>
                                            ...
                                            <tr>
                                                <?php foreach ($kode_valas as $ko_val1) { ?>
                                                    <?php if(!empty($ko_val1['kode_valas'])){ ?>
                                                        <th class="text-center" style="color: #5a5c69;"><?php echo $ko_val1['kode_valas']?></th>
                                                    <?php } else { ?>
                                        ...
                                        <tbody>
                                            <?php foreach ($kategori as $k => $kat) {
                                                ...
                                                $tambah = site_url("treasurypjum/$id_kategori/$id_transaksi/$jenis_biaya/$id_pjum_tanggal");
                                                $hapus = site_url("treasurypjum/$id_kategori/$id_transaksi/$jenis_biaya/$id_pjum_tanggal/?aksi=hapus&id_kategori=$id_kategori");
                                            ?>
                                                <tr>
                                                                ...
                                                                <?php if($role == 'admin' && $submit == 0 || $role == 'user' && $submit == 0) { ?>
                                                                    ...
                                                                    <?php if ($kat['treasury'] == null && $kat['edited_by'] == null && $kirim == 0) { ?>
                                                                        <th class="text-right" scope="row">
                                                                            <a href="<?php echo site_url("editbiayapjum/$id_biaya/$id_kategori/$id_transaksi/$jenis_biaya/$id_pjum_tanggal") ?>" style="color: #5a5c69"><abbr title="Klik untuk melakukan edit biaya" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo $bia['simbol']; echo number_format($bia['biaya'], 2, ',', '.');?></abbr></a>
                                                                        </th>
                                                                    ...
                                                                    <?php } else if ($kat['treasury'] == null && $kat['edited_by'] != null && $kirim == 1) { ?>
                                                                        <th class="text-right" scope="row">
                                                                            <a href="<?php echo site_url("editbiayapjum/$id_biaya/$id_kategori/$id_transaksi/$jenis_biaya/$id_pjum_tanggal") ?>" style="color: #4e73df"><abbr title="Klik untuk melakukan edit biaya" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo $bia['simbol']; echo number_format($bia['biaya'], 2, ',', '.');?> (Telah diubah)</abbr></a>
                                                                        </th>
                                                                    <!-- perlu revisi -->
                                                                    <?php } else if ($kat['treasury'] != null && $kat['edited_by'] == null && $kirim == 1) { ?>
                                                                        <th class="text-right" scope="row">
                                                                            <a href="<?php echo site_url("editbiayapjum/$id_biaya/$id_kategori/$id_transaksi/$jenis_biaya/$id_pjum_tanggal") ?>" style="color: #e74a3b"><abbr title="Klik untuk melakukan edit biaya" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo $bia['simbol']; echo number_format($bia['biaya'], 2, ',', '.');?> (Perlu revisi)</abbr></a>
                                                                        </th>
                                                                    <!-- telah direvisi -->
                                                                    <?php } else if ($kat['treasury'] != null && $kat['edited_by'] != null && $kirim == 1) { ?>
                                                                        <th class="text-right" scope="row">
                                                                            <a href="<?php echo site_url("editbiayapjum/$id_biaya/$id_kategori/$id_transaksi/$jenis_biaya/$id_pjum_tanggal") ?>" style="color: #1cc88a"><abbr title="Klik untuk melakukan edit biaya" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo $bia['simbol']; echo number_format($bia['biaya'], 2, ',', '.');?> (Telah direvisi)</abbr></a>
                                                                        </th>
                                                                    <?php } ?>
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Total Biaya Tukar Uang Keluar</th>
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Total Biaya Tukar Uang Masuk</th>
                                            <?php foreach ($tukarMasuk as $tukarm) {
                                            $biaya = implode("", $tukarm);
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Total Biaya Kembalian</th>
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Total Seluruh Pengeluaran</th>
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Sisa Uang Seharusnya</th>
                                            <?php foreach ($pum as $p => $pu1) { ?>
                                                <?php foreach ($uangMasuk as $tk => $uangm) { ?>
                                                    <?php foreach ($total as $tl => $tot1) { ?>
                                                        <?php if ($pu1['id_valas'] == $uangm['id_valas'] && $uangm['id_valas'] == $tot1['id_valas']) {
                                                            // $sisa = ($pu1['pum'] + $tukar['uangmasuk']) - $tot1['pengeluaran'];
                                                            $sisa = $pu1['pum'] - $tot1['pengeluaran'];
                                                        ?>
                                                            <?php if(!($tot1['pengeluaran'] == null)){ ?>
                                                                <th class="text-right" scope="row" style="color: #5a5c69">
                                                                    <?php echo $tot1['simbol']; echo number_format($sisa, 2, ',', '.');?>
                                                                </th>
                                                            <?php } else { ?>
                                                                <th class="text-right" scope="row"></th>
                                                            <?php } ?>
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Sisa Uang Dikembalikan</th>
                                            <?php foreach ($pum as $p => $pu2) { 
                                                $id_pum = $pu['id_pum'];
                                                $id_pjum = $pu['id_pjum'];
                                                $id_transaksi = session()->get('id_transaksi');
                                            ?>
                                                <?php if(!($pu2['uang_kembali'] == null)){ ?>
                                                    <?php if($role == 'admin' && $submit == 0 || $role == 'user' && $submit == 0 ) { ?>
                                                        <th class="text-right" scope="row" style="color: #5a5c69">
                                                            <a href="<?php echo site_url("editbiayasisa/$id_pum/$id_transaksi/$jenis_biaya/$id_pjum") ?>" style="color: #5a5c69"><abbr title="Klik untuk melakukan edit biaya" style="text-decoration:none;-webkit-text-decoration:none;text-decoration:none;cursor:pointer;border-bottom:0;-webkit-text-decoration-skip-ink:none;text-decoration-skip-ink:none"><?php echo $pu2['simbol']; echo number_format($pu2['uang_kembali'], 2, ',', '.');?></abbr></a>
                                                        </th>
                                                    <?php } else { ?>
                                                        <th class="text-right" scope="row" style="color: #5a5c69">
                                                            <?php echo $pu2['simbol']; echo number_format($pu2['uang_kembali'], 2, ',', '.');?>
                                                        </th>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <th class="text-right" scope="row"></th>
                                        ...
                                        <tr>
                                            <th colspan ="6" style="color: #5a5c69">Kelebihan/kekurangan</th>
                                            <?php foreach ($pum as $p => $pu3) { ?>
                                                <?php foreach ($uangMasuk as $tk => $uangm1) { ?>
                                                    <?php foreach ($total as $tl => $tot2) { ?>
                                                        <?php if ($pu3['id_valas'] == $uangm1['id_valas'] && $uangm1['id_valas'] == $tot2['id_valas']) {
                                                            $uangkembali = $pu3['uang_kembali'] - ($pu3['pum'] - $tot2['pengeluaran']);
                                                        ?>
                                                            <?php if(!($tot2['pengeluaran'] == null)) { ?>
                                                                <th class="text-right" scope="row" style="color: #5a5c69">
                                                                    <?php echo $tot2['simbol']; echo number_format($uangkembali, 2, ',', '.');?>
                                                                </th>
                                                            <?php } else { ?>
                                                                <th class="text-right" scope="row"></th>
                                                            <?php } ?>
    ...
    <div class="modal fade" id="uploadExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url("importpjum/$jenis_biaya/$id_transaksi/$id_pjum_tanggal") ?>" method="POST" enctype="multipart/form-data"><!-- enctype="multipart/form-data" -->
