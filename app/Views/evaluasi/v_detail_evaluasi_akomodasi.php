            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <h1>Detail Evaluasi Akomodasi</h1>
                                <?php $eval_akomodasi_user = site_url("eval_akomodasi_user");?>
                                <a class="btn btn-secondary mb-3" href="<?php echo $eval_akomodasi_user?>" style="font-size:120%;">Kembali</a>
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="table-responsive text-nowrap">
                                        <table class="text-center" style="width: 100%; font-size:200%;">
                                            <?php foreach ($e_akomodasi as $ae => $ako) {?>
                                                <tbody>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th colspan ="2" style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Hotel</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;"><?php echo $ako['nama_hotel'] ?></th>
                                                    </tr>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th colspan ="2" style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Nama/Jabatan</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;"><?php echo $ako['atas_nama'] ?> <?php echo "(" ?><?php echo $ako['jabatan'] ?><?php echo ")" ?></th>
                                                    </tr>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th colspan ="2" style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Tanggal</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;"><?php echo tanggal_jam_transaksi_kendaraan($ako['tanggal_jam_masuk']) ?> <?php echo 's/d' ?> <?php echo tanggal_jam_transaksi_kendaraan($ako['tanggal_jam_keluar']) ?></th>
                                                    </tr>
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        ...
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Kondisi Hotel</th>
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px; background-color: #D6EEEE;">
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">e. TV</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">f. Toilet</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px; background-color: #D6EEEE;">
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">g. Makan Pagi</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        ...
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Sikap Petugas Adm. Akomodasi</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                    </tr>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px; background-color: #D6EEEE;">
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px; background-color: #D6EEEE;">
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">c. Inisiatif</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;"></th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">d. Cekatan dalam menindaklanjuti pesanan</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
