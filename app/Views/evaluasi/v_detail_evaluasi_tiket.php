            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <h1>Detail Evaluasi Tiket</h1>
                                <?php $eval_tiket_user = site_url("eval_tiket_user");?>
                                <a class="btn btn-secondary mb-3" href="<?php echo $eval_tiket_user?>" style="font-size:120%;">Kembali</a>
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="table-responsive text-nowrap">
                                        <table class="text-center" style="width: 100%; font-size:200%;">
                                            <?php foreach ($e_tiket as $et => $tik) {?>
                                                <tbody>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th colspan ="2" style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Tiket</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;"><?php echo $tik['nama_vendor'] ?></th>
                                                    </tr>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th colspan ="2" style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Nama/Jabatan</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;"><?php echo $tik['atas_nama'] ?> <?php echo "(" ?><?php echo $tik['jabatan'] ?><?php echo ")" ?></th>
                                                    </tr>
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        <th colspan ="2" style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Tanggal Tiket</th>
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;"><?php echo tanggal_jam_transaksi_kendaraan($tik['tanggal_jam_tiket']) ?></th>
                                                    </tr>
                                                    ...
                                                    <tr style="border: 3px solid #03c3ec; text-align: center; padding: 8px;">
                                                        ...
                                                        <th style="border: 3px solid #03c3ec; text-align: left; padding: 8px;">Sikap Petugas Adm. Tiket</th>
