                                    ...
                                    <table id="myTable" class="display nowrap cell-border" style="width=100%">
                                        <thead>
                                            <tr class="align-text-center">
                                                ...
                                                <th class="text-center" style="color: #5a5c69;">Negara</th>
                                                <th class="text-center" style="color: #5a5c69;">Aksi</th>
                                                <th class="text-center" style="color: #5a5c69;">Master Kota</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i=1;?>
                                            <?php foreach ($negara as $n => $neg) {
                                                ...
                                                $edit_negara = site_url("edit_negara/$id_negara");
                                                $hapus = site_url("negara/?aksi=hapus&id_negara=$id_negara");
                                            ?>
                                                <tr>
                                                    <td class="text-center col-1" style="color: #5a5c69;"><?php echo $i++?></td>
                                                    <td class="text-center" style="color: #5a5c69;"><?php echo $neg['nama_negara']?></td>
                                                    <td class="text-center" style="color: #5a5c69;">
                                                        <a class="btn btn-info btn-lg mb-3"
                                                            style="font-size:80%;" href="<?php echo $edit_negara?>">Edit</a>
                                                        <a class="btn btn-danger btn-lg mb-3" href="<?php echo $hapus?>" onclick="return confirm('Yakin akan menghapus data negara?')"
                                                            style="font-size:80%;">Hapus</a>
                                                    </td>
                                                    <td class="text-center" style="color: #5a5c69;">
                                                        <a class="btn btn-success btn-lg mb-3" style="font-size:80%;" href="<?php echo $kota?>">Lihat master kota</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="font-size:120%;">
                ...
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel">Tambah Data Negara</h2>
