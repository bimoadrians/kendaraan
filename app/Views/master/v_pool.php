                                    ...
                                    <table id="myTable" class="display nowrap cell-border" style="width=100%">
                                        <thead>
                                            <tr class="align-text-center">
                                                ...
                                                <th class="text-center" style="color: #5a5c69;">No HP</th>
                                                <th class="text-center" style="color: #5a5c69;">Email</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($pool as $p => $poo) {
                                                $id_pool = $poo['id_pool'];
                                                $edit_pool = site_url("edit_pool/$id_pool");
                                                $hapus = site_url("pool/?aksi=hapus&id_pool=$id_pool");
                                            ?>
                                                <tr>
                                                    <td class="text-center col-1" style="color: #5a5c69;"><?php echo $i++ ?></td>
                                                    <td class="text-center" style="color: #5a5c69;"><?php echo $poo['nama_pool'] ?></td>
                                                    <td class="text-center" style="color: #5a5c69;"><?php echo $poo['no_hp_pool'] ?></a>
                                                    </td>
                                                    <td class="text-center" style="color: #5a5c69;"><?php echo $poo['email_pool'] ?></a>
                                                    </td>
                                                    <td class="text-center" style="color: #5a5c69;">
                                                        <a class="btn btn-info btn-lg mb-3"
                                                            style="font-size:80%;" href="<?php echo $edit_pool?>">Edit</a>
                                                        <a class="btn btn-danger btn-lg mb-3" href="<?php echo $hapus?>" onclick="return confirm('Yakin akan menghapus data pool?')"
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="font-size:120%;">
                ...
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel">Tambah Data Pool</h2>
                    ...
                    <div class="modal-body">
                        <div class="tab-content">
                            <div class="tab-pane active show" style="font-size:120%">
                                ...
                                <div class="mb-3">
                                    <input required autocomplete="off" type="text" class="form-control" name="nama_pool" id="nama_pool">
                                </div>
                                ...
                                <div class="mb-3">
                                    <input required autocomplete="off" min="0" type="number" class="form-control" name="no_hp_pool" id="no_hp_pool">
                                </div>
                                ...
                                <div class="mb-3">
                                    <input required autocomplete="off" type="text" class="form-control" name="email_pool" id="email_pool">
                                </div>
                                <script>
