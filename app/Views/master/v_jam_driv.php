             ...
             <div class="col-lg-12 mb-4 order-0">
                 <div class="card">
                     <div class="d-flex align-items-end row">
                         <div class="col-sm-12">
                             <div class="card-body">
                                 <h1>Master Jam Tersedia Driver</h1>
                                     ...
                                     <table id="myTable" class="display nowrap cell-border" style="width=100%">
                                         <thead>
                                             <tr class="align-text-center">
                                                 ...
                                                 <th class="text-center" style="color: #5a5c69;">Pengemudi</th>
         ...
         <div class="modal-dialog">
             <div class="modal-content" style="font-size:120%;">
                 ...
                 <div class="modal-header">
                     <h2 class="modal-title" id="exampleModalLabel">Tambah Data Jam Tersedia Driver</h2>
                     ...
                     <div class="modal-body">
                         <div class="tab-content">
                             <div class="tab-pane active show" style="font-size:120%">
                                 ...
                                 <select class="select_pengemudi" name="pengemudi" style="width: 100%;"></select>
                                 <script>
                                 ...
                                 <div class="mb-3">
                                     <input autocomplete="off" type="month" class="form-control" name="bulan"
                                         id="bulan">
                                 </div>
