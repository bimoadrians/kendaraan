                                    ...
                                    <table id="myTable" class="display nowrap cell-border" style="width=100%">
                                        <thead>
                                            <tr class="align-text-center">
                                                ...
                                                <th class="text-center" style="color: #5a5c69;">Tujuan</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($tujuan as $t => $tuj) {
                                                ...
                                                $edit_tujuan = site_url("edit_tujuan/$id_tujuan");
                                                $hapus = site_url("tujuan/?aksi=hapus&id_tujuan=$id_tujuan");
                                            ?>
                                                <tr>
                                                    <td class="text-center col-1" style="color: #5a5c69;"><?php echo $i++?></td>
                                                    <td class="text-center" style="color: #5a5c69;"><?php echo $tuj['nama_tujuan'] ?></td>
                                                    <td class="text-center" style="color: #5a5c69;">
                                                        <a class="btn btn-info btn-lg mb-3"
                                                            style="font-size:80%;" href="<?php echo $edit_tujuan?>">Edit</a>
                                                        <a class="btn btn-danger btn-lg mb-3" href="<?php echo $hapus?>" onclick="return confirm('Yakin akan menghapus data tujuan?')"
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="font-size:120%;">
                ...
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel">Tambah Data Tujuan</h2>
                    ...
                    <div class="modal-body">
                        <div class="tab-content">
                            <div class="tab-pane active show" style="font-size:120%">
                                ...
                                <div class="mb-3">
                                    <input autocomplete="off" type="text" class="form-control" name="nama_tujuan"
                                        id="nama_tujuan">
                                </div>
                            </div>
                            <script>
