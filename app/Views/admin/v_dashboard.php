                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-xl-12 col-lg-12 mb-4">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <?php } else if ($role == 'admin' && $submit_pjum == 0 && $submit_pb == 0 || $role == 'user' && $submit_pjum == 0 && $submit_pb == 0) { ?>
                                        ...
                                        <?php } else if ($role == 'treasury' && empty($biayapb) || $role == 'treasury' && $submit_pjum == 1 && $submit_pb == 0 && $created_by == '05080') { ?>
                        ...
                        <div class="row">
                                        ...
                                        <div class="card border-left-danger shadow h-100 py-2">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="h2 mb-0 font-weight-bold text-gray-800"><i class="fa-solid fa-credit-card"></i> PJUM</div>
                                                    </div>
                            ...
                            <?php } else { ?>
                                ...
                                if ($role == 'admin' && $created_by != '05080' || $role == 'user' && $created_by != '05080' || $role == 'treasury' && $submit_pb == 1 || $role == 'treasury' && $submit_pb == 0 && $created_by == '05080') { ?>
                                    <div class="col-xl-6 col-md-6 mb-4">
                                        <div class="card border-left-primary shadow h-100 py-2">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="h2 mb-0 font-weight-bold text-gray-800"><i class="fa-solid fa-sack-dollar"></i> PB</div>
                                                    </div>
                                ...
                                <div class="col-xl-12 col-md-6 mb-4">
                                    <div class="card border-left-danger shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="h2 mb-0 font-weight-bold text-gray-800"><i class="fa-solid fa-square-caret-down"></i> Biaya Support</div>
                                                </div>
