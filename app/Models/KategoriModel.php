...
class KategoriModel extends Model
{
    ...
    // UPDATE pengguna SET nik_pengguna =concat('0', nik_pengguna) WHERE id_pengguna IN(1);
    // UPDATE pengguna SET nik_pengguna = REPLACE(nik_pengguna, ' ', '');
    // SELECT * FROM pengguna WHERE LENGTH(nik_pengguna) = 4;
