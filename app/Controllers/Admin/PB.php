...
class PB extends BaseController
{
        ...
        if($this->request->getMethod()=='post') {
            if ($this->request->getVar('nomor') == null || $this->request->getVar('nomor') == '') {
                if ($role == 'admin' || $role == 'user') {
                    ...
                    //     // $mail->addAddress('09002@intra.net');//Add a recipient (Treasury)
                    ...
                    //     // $mail->addAddress('09002@intra.net');//Add a recipient (User Bagian)
                    
                    //     //Content
                    //     $link='https://konimex.com:447/pdln/listpb/pb/'.$id_transaksi;
                    //     $mail->Subject = 'Data PB Telah Diperiksa Bagian Treasury';
                    //     $mail->Body    = nl2br("Bagian Treasury telah selesai melakukan pengecekan data PB, untuk melihat revisi data PB silahkan klik link: $link");
                    ...
                    //     $mail->Body    = nl2br("Bagian GS telah selesai melakukan pengecekan data PB User bagian (").$niknmuser['niknm']."/".$nikuser['nik']."/".$nikuser['strorgnm'].("), untuk melihat revisi data PB silahkan klik link: $link");
    ...
    public function treasuryselesaipb($jenis_biaya, $id_transaksi)
    {
        ...
        //     // $mail->addAddress('09002@intra.net');//Add a recipient (GS)
        
        //     //Content
        //     $link='https://konimex.com:447/pdln/listpb/pb/'.$id_transaksi;
        //     $mail->Subject = 'Data PB Telah Divalidasi Bagian Treasury';
        //     $mail->Body    = nl2br("Bagian Treasury telah melakukan validasi data PB User bagian (").$niknmuser['niknm']."/".$nikuser['nik']."/".$nikuser['strorgnm'].("), untuk melihat data PB silahkan klik link: $link");
