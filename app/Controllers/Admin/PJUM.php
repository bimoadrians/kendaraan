        ...
        if($this->request->getMethod() == 'post') {
            if ($this->request->getVar('nomor') == null || $this->request->getVar('nomor') == '') {
                if ($role == 'admin' || $role == 'user') {
                    ...
                    //     //Content
                    //     $link = 'https://konimex.com:447/pdln/listpjum/pjum/'.$id_transaksi;
                    //     $mail->Subject = 'Data PJUM Siap Periksa';
                    //     $mail->Body    = nl2br("User bagian (").$niknmuser['niknm']."/".$nikuser['nik']."/".$nikuser['strorgnm'].(") telah selesai mengisi data PJUM, silahkan periksa data PJUM dengan cara klik link: $link");
                    ...
                    //     $mail->Body    = nl2br("Bagian Treasury telah selesai melakukan pengecekan data PJUM, untuk melihat revisi data PJUM silahkan klik link: $link");
